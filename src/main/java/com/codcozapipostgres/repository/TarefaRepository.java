...
public interface TarefaRepository extends JpaRepository<Tarefa, Long> {
    ...
    List<Object[]> buscarPorData(@Param("data") LocalDate data, @Param("email") String email);

    @Query(value = "SELECT * FROM func_lista_tarefa_periodo(:dataInicio,:dataFim,:email)",nativeQuery = true)
    List<Object[]> buscarPorPeriodo(@Param("dataInicio") LocalDate dataInicio, @Param("dataFim") LocalDate dataFim, @Param("email") String email);

    @Query(value = "SELECT * FROM func_lista_tarefa_periodo(:dataInicio,:dataFim,:email) WHERE tipo_tarefa = :tipo",nativeQuery = true)
    List<Object[]> buscarPorTipo(@Param("dataInicio") LocalDate dataInicio, @Param("dataFim") LocalDate dataFim, @Param("email") String email, @Param("tipo") String tipo);
